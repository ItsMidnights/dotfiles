# Michael Casas (Schadough)
# http://www.youtube.com/schadough
# http://www.gitlab.com/schadough/

### ADDING TO THE PATH
# First line removes the path; second line sets it.  Without the first line,
# your path gets massive and fish becomes very slow.
set -e fish_user_paths
set -U fish_user_paths $HOME/.local/bin $HOME/Applications $HOME/Development/tools/nvim/bin $fish_user_paths
